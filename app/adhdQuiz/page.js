...
const CONFIG = {
  ...
  intro:
    "See if this sounds familiar. This takes about two minutes.",
  ...
  items: [
    "had trouble wrapping up the final details of a project or task once the challenging parts were done?",
    "found it difficult to get things in order for tasks that required organization?",
    "had problems remembering appointments, deadlines, or daily obligations?",
    "avoided, delayed, or procrastinated on tasks that required a lot of mental effort or concentration?",
    "fidgeted with their hands or feet, or squirmed when required to sit still for a long time?",
    "felt overly active, restless, or compelled to do things as if driven by a motor?",
  ],
  ...
  trailing: [
    {
      text: "If the person is an adult, has he or she experienced these same noticeable difficulties with attention, organization, or sitting still before the age of 12?",
      choices: [
        "Yes",
        "No",
        "Not applicable (child)",
        "I don't know / the person doesn't remember",
      ],
      modifierTrigger: "No",
    },
    {
      text: "Do any of these difficulties currently cause significant problems for the person of interest in at least two areas of life, such as work, school, home, or social relationships?",
      choices: ["Yes", "No"],
      modifierTrigger: "No",
    },
  ],
...
Please know that The Center for Child and Family Psychiatry is an outpatient clinic — we are not an emergency room or urgent care facility, and we are not able to respond to crisis situations in real time. Because safety comes first, we strongly recommend getting help immediately from one of the resources above rather than waiting for a scheduled appointment.`,
  ...
  structuredResults: {
    tiers: {
      likely: {
        opener:
          "Your answers show a number of patterns that are often linked to ADHD.",
      ...
      possible: {
        opener:
          "Your answers show a few signs that could be related to ADHD, but the pattern isn't strong enough to say either way.",
    ...
    definition:
      "ADHD involves ongoing patterns of trouble focusing, staying organized, or sitting still that get in the way of daily life.",

    differentials: [
      {
        name: "Anxiety",
        desc: "Worry can look like distraction.",
      },
      {
        name: "Sleep Problems",
        desc: "Poor sleep affects focus and mood.",
      },
      {
        name: "Learning Differences",
        desc: "Can make school or work tasks harder to manage.",
      },
      {
        name: "Autism Spectrum Traits",
        desc: "Can also involve difficulty with attention and organization.",
      },
    ],

    family:
      "ADHD often affects routines, communication, and expectations at home just as much as it affects the person themselves. Family therapy can help build structure and reduce frustration for everyone involved.",

    group:
      "Group therapy offers a space to build practical skills, like organization and time management, alongside peers facing similar challenges.",
  },
...
export default function AnxietyQuizPage() {
  ...
  steps.forEach((currentStep, index) => {
    if (
      ...
      if (answer === currentStep.modifierTrigger) {
        tier = "possible";
      }
    }
  });
