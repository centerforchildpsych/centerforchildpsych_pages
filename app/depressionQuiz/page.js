...
export default function AnxietyQuizPage() {
  ...
  /*
   * The safety question is always the first question,
   * so its answer is stored at key 0.
   */
  const safetyFlag = Number(answers[0] ?? 0) > 0;

  /*
   * Only score the actual anxiety questions.
   * The safety question is excluded from the anxiety score.
   */
