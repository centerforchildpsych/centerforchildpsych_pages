...
function Header() {
    ...
    return (
        <>
            <p className={styles.easeyStyle}>1103 N. Gray Street | Killeen, TX 76541 | (254) 774-1163 | centerforchildpsych@gmail.com</p>
            ...
            <div className={`${styles.scrollngHeader} ${stickyHeader ? styles.sticky : styles.stickyOffset}`}>
                ...
                <div className={`${styles.navLinks} ${menuOpen ? styles.active : ''}`.trim()}>
                    ...
                    <a className={styles.navBarLink} href='#'>Accepted Insurances</a>
                    <a className={styles.navBarLink} href='https://27185.portal.athenahealth.com/'>Patient Portal</a>
                    <a className={styles.navBarLink} href='https://consumer.scheduling.athena.io/?locationId=27185-1'>BOOK NOW</a>
                    <a className={styles.navBarLink} href='#'>TMS</a>
                </div>
